...
export default {
  ...
  "tool.orbitTitle": "ドラッグで回転、表面をダブルクリックで印を置きます",
  "tool.brush": "ブラシ",
  ...
  "hint.orbit":
    "ドラッグで回転 · ダブルクリックで印 · 右ドラッグで平行移動 · ホイールでズーム",
  "hint.paint": "見えている面を塗る · Option/Alt を押しながらドラッグで回転",
  "hint.erase":
    "見えているストロークを消す · モデル自体は変わりません · Option/Alt で回転",
  "hint.fill": "重ねてプレビュー · クリックで塗る · Option/Alt で回転",
  ...
  "feedback.downloadMarks": "印をダウンロード",
  "feedback.downloadModel": "この版をダウンロード",
  "feedback.finish": "この回を終了",
  "feedback.submit": "エージェントへ送る",
  "feedback.submitting": "送信中…",
  "feedback.submitted":
    "印を保存しました。送信状況は実際の受領確認に従います。モデルはロックしたままです。",
  "feedback.roundSealed":
    "この回は終了しました。未送信の印は封をして、この回とともにエージェントへ送りました。",
  "feedback.roundClosed":
    "この回は終了しました。送信済みの印は保存されています。",

  "help.open": "使い方",
  "help.eyebrow": "クイックスタート",
  "help.title": "見て、印を付けて、何を変えたいか伝える。",
  "help.p1":
    "左ボタンを押したままドラッグで回転、右ボタンで平行移動、ホイールでズームします。ツールを切り替えなくても印を置けます。",
  "help.p2":
    "印：モデルの表面をダブルクリックすると A、B、C が置かれます。単なるクリックでは何も置かれません。ブラシ：今見えている表面だけを塗ります。Option/Alt を押しながらドラッグすると一時的に回転でき、離せば続けて塗れます。",
  "help.p3":
  ...
  "help.p5":
    "印は模様で区別でき、ひと押しで隠せます。単色表示は見るための補助です。ダウンロードは元の色とテクスチャを保ち、印は含みません。",
  "help.p6":
  ...
  "help.p8":
    "ひと通り終わったら「この回を終了」を押してください。未送信の印は封をして、この回とともにエージェントへ送られます。その後また印を付けると、自動で次の回が始まります。下書きは自動保存されます。",
  "help.p9":
