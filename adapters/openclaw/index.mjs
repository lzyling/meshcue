...
const parameters = {
  ...
  properties: {
    ...
    file: {
      type: "string",
      description:
        "Existing GLB or STL source, relative to this workspace. open imports/publishes it; precheck only measures it. Hard limits are 600000 triangles and 80 MB, and they are the only limits: marking is as precise on a dense model as on a sparse one.",
    },
    name: { type: "string" },
    version: { type: "string" },
    units: { type: "string" },
